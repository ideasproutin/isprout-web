        ...
        <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2 sm:space-y-3">
              {[
                ...
                { label: "Virtual Office", link: "/virtual-office" },
                { label: "Meeting Rooms", link: "/meeting-rooms" },
              ].map((item, i) => (
                <li key={i}>
                  <a
                    href={item.link}
          ...
          <div>
            ...
            <div className="flex flex-wrap gap-3 mb-4">
              {[
                { icon: instagram, link: "https://www.instagram.com/isproutcoworkingspace/" },
                { icon: facebook, link: "https://www.facebook.com/isprout" },
                { icon: twitter, link: "https://x.com/isproutbc" },
                { icon: youtube, link: "https://www.youtube.com/@isproutbusinesscentre236" },
                { icon: linkedin, link: "https://in.linkedin.com/company/isprout" },
              ].map((social, i) => (
                <a
                  key={i}
                  href={social.link}
