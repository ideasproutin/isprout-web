...
export const nearbyLocationsData: CenterNearbyData = {
	...
	orbit: {
		...
		airport: [{ name: "Rajiv Gandhi International Airport", distance: "36 KM" }],
	},
	"my home twitza": {
	...
	"jayabheri trendset connect": {
		...
		airport: [{ name: "Rajiv Gandhi International Airport", distance: "37 KM" }],
	},
	"sohini tech park": {
	...
	"modern profound": {
		...
		hotels: [{ name: "Novotel Hyderabad Convention Centre", distance: "4.8 km" }],
	...
	"pranava one": {
		...
		airport: [{ name: "Rajiv Gandhi International Airport", distance: "30 KM" }],
	},
	"minaas towers": {
		...
		airport: [{ name: "Rajiv Gandhi International Airport", distance: "38 KM" }],
	},
	"sas towers": {
		...
		airport: [{ name: "Rajiv Gandhi International Airport", distance: "34.5 KM" }],
	},
	"medha towers": {
		...
		metro: [],
		airport: [{ name: "Vijayawada International Airport", distance: "1.0 KM" }],
	},
	"benz circle": {
		...
		metro: [],
		airport: [{ name: "Vijayawada International Airport", distance: "18 KM" }],
	},
	"kochar jade": {
		...
		airport: [{ name: "Chennai International Airport", distance: "6.8 KM" }],
	},
	"saravana matrix tower": {
		...
		airport: [{ name: "Chennai International Airport", distance: "14.5 KM" }],
	},
	"panchshil techpark": {
	...
	"shilpitha tech park": {
		...
		hotels: [{ name: "Novotel Bengaluru Outer Ring Road", distance: "450M" }],
		...
		airport: [{ name: "Kempegowda International Airport Bengaluru", distance: "43 KM" }],
	},
	"nr enclave": {
		...
		metro: [{ name: "Sri Sathya Sai Hospital Metro Station", distance: "750m" }],
		airport: [{ name: "Kempegowda International Airport Bengaluru", distance: "39 KM" }],
	},
	"prestige saleh ahmed": {
		...
		airport: [{ name: "Kempegowda International Airport Bengaluru", distance: "33.3 KM" }],
	},
	"hq27 the headquarters": {
		...
		airport: [{ name: "Indira Gandhi International Airport", distance: "15.2 KM" }],
	},
	aurelien: {
		...
		airport: [{ name: "Sardar Vallabhbhai Patel International Airport", distance: "23.7 KM" }],
	},
	"godrej waterside": {
		...
		airport: [{ name: "Netaji Subhash Chandra Bose International Airport", distance: "12 km" }],
	},
};
