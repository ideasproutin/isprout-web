...
const IntroSection = () => {
  const StatLeaf = ({ value, label, variant }: StatLeafProps) => {
    ...
    return (
      ...
      >
        <p className="text-lg sm:text-xl font-bold" style={{ color: COLORS.textBlack }}>
          {value}
        </p>
        <p className="text-xs sm:text-sm" style={{ color: COLORS.textBlack }}>
          {label}
        </p>
      </div>
    );
  ...
  return (
    <section className="relative w-full overflow-hidden pt-0 pb-8 sm:pb-12 lg:pb-16">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative w-full max-w-xl lg:max-w-2xl mx-auto">
            ...
            <div className="flex flex-col gap-6 lg:hidden">
              <img src={aboutusImg1} alt="iSprout Office" className="rounded-2xl w-full object-cover" />
              <img src={aboutusImg2} alt="iSprout Team" className="rounded-2xl w-full object-cover" />

              <div className="relative">
                <img src={aboutusImg3} alt="iSprout Workspace" className="rounded-2xl w-full object-cover" />

                <div
                  className="absolute -bottom-4 -right-4 px-6 py-3 rounded-lg shadow-lg"
                  style={{ backgroundColor: COLORS.brandYellow }}
                >
                  <p className="text-2xl font-bold" style={{ color: COLORS.textPrimary }}>17k+</p>
                  <p className="text-sm font-semibold" style={{ color: COLORS.textPrimary }}>Places</p>
                </div>
              </div>
            </div>
            ...
            <div className="hidden lg:block relative h-[520px]">
              <img
                src={aboutusImg1}
                alt="iSprout Office"
                className="absolute top-0 left-8 w-[75%] rounded-2xl object-cover z-10"
              />
              ...
              <div className="absolute bottom-16 left-8 w-[35%] z-30">
                <img src={aboutusImg3} alt="iSprout Workspace" className="rounded-2xl object-cover" />
              ...
              {/* Decorative Ring */}
              <svg
                className="absolute bottom-24 right-0 w-56 h-56 pointer-events-none"
                viewBox="0 0 192 192"
                aria-hidden="true"
              >
                <circle
