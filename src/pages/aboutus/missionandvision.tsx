              ...
              <div className="space-y-3 sm:space-y-4 w-full">
                ...
                <div className="flex justify-center">
                  <svg
                    ...
                    fill="none"
                  >
                    <circle cx="24" cy="24" r="22" stroke={COLORS.brandBlue} strokeWidth="2" />
                    <circle cx="24" cy="24" r="16" stroke={COLORS.brandBlue} strokeWidth="2" />
                    <circle cx="24" cy="24" r="10" stroke={COLORS.brandBlue} strokeWidth="2" />
                ...
                >
                  Our mission is simple — to create workspaces that inspire,
                  energize, and empower. We believe that when you love where you
              ...
              <div className="space-y-3 sm:space-y-4 w-full">
                ...
                <div className="flex justify-center">
                  <svg
                    ...
                    fill="none"
                  >
                    <path d="M24 6C18.477 6 14 10.477 14 16C14 19.5 15.5 22.6 18 24.5V30C18 31.1 18.9 32 20 32H28C29.1 32 30 31.1 30 30V24.5C32.5 22.6 34 19.5 34 16C34 10.477 29.523 6 24 6Z" stroke={COLORS.brandBlue} strokeWidth="2" />
                ...
                <p
                  ...
                  style={{ fontFamily: 'Outfit, sans-serif', color: COLORS.textGray800 }}
                >
                  Our vision is to be the go-to partner for businesses that want
                  to take their workspace game to the next level — creating
                  offices that are hubs of creativity, collaboration, and
                  community.
                </p>
              </div>
            </div>
