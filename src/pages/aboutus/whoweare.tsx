  ...
  return (
    <section className="py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {/* Who we are */}
        <div className="relative rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-lg" style={{ backgroundColor: '#FFF9E6' }}>
          <div className="flex flex-col justify-between min-h-[200px]">
            <div className="flex justify-between items-start">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold" style={{ fontFamily: 'Outfit, sans-serif' }}>Who we are</h2>
              <img src={whoweare1} alt="" className="w-12 h-12 sm:w-14 sm:h-14 md:w-16 md:h-16" />
            </div>
            <p className="text-base sm:text-lg md:text-xl lg:text-2xl max-w-4xl mt-4" style={{ fontFamily: 'Outfit, sans-serif', color: '#204758' }}>
        ...
        <div className="relative rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-lg" style={{ backgroundColor: '#FFF9E6' }}>
          <div className="flex flex-col justify-between min-h-[200px]">
            <div className="flex justify-between items-start">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold" style={{ fontFamily: 'Outfit, sans-serif' }}>What we do</h2>
        ...
        <div className="relative rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-lg" style={{ backgroundColor: '#FFF9E6' }}>
          <div className="flex flex-col justify-between min-h-[200px]">
            <div className="flex justify-between items-start">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold" style={{ fontFamily: 'Outfit, sans-serif' }}>How we help</h2>
        ...
        <div className="relative rounded-3xl p-6 sm:p-8 md:p-10 lg:p-12 shadow-lg" style={{ backgroundColor: '#FFF9E6' }}>
          <div className="flex flex-col justify-between min-h-[200px]">
            <div className="flex justify-between items-start">
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold" style={{ fontFamily: 'Outfit, sans-serif' }}>Creating success stories</h2>
