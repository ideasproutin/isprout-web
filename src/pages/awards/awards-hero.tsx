		...
		<section
			...
			>
				<div className='absolute bottom-0 left-0 right-0 z-10 bg-black/40 py-3 sm:py-4 md:py-5 lg:py-6 px-4 sm:px-8 md:px-12 lg:px-20 xl:px-24'>
					<h1 className="text-white text-2xl sm:text-2xl md:text-4xl lg:text-5xl xl:text-6xl 2xl:text-7xl font-bold font-['Inter',sans-serif]" style={{ fontSize: "clamp(1.5rem, 5vw, 3.75rem)" }}>
