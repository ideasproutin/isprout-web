		...
		>
			...
			<div className='relative w-full h-[600px] overflow-hidden bg-[rgba(255,222,0,0.16)]'>
				...
				<p className='absolute left-[60px] top-[170px] w-[520px] text-[17px] text-white leading-relaxed z-10'>
					...
					commitment to innovation, service quality, and workspace
					experience has earned us multiple recognitions across the
					country. These awards reflect our journey of transforming
					offices into dynamic, future-ready work environments.
				</p>
						...
						>
							<g filter='url(#filter0_dd_circle1)'>
								<circle
									cx='119'
									cy='115'
									fill={COLORS.backgroundLightGray}
									r='115'
								/>
							</g>
							<defs>
