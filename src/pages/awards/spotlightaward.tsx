...
import { spotlightAwardContent } from '../../content/awards';
    ...
    <article className="relative pt-5 lg:pt-[30px] pb-[60px]">
      ...
      <div className="container mx-auto px-4 lg:px-0 relative flex items-center min-h-[550px]">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 items-center max-w-[1200px] mx-auto w-full">
          ...
          <div className="relative lg:pr-20 flex flex-col items-center justify-center lg:-mt-8">
            {/* Large award card */}
