...
import { womenLeaderContent } from '../../content/awards';
 
const WomenLeader = () => {
  return (
    <article className="relative pt-10 lg:pt-[60px] pb-20 lg:pb-[100px]">
      {/* Dark Teal Side Bar */}
