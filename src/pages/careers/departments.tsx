      ...
      <div className="max-w-[1280px] mx-auto">
        ...
        <div className="flex justify-center mb-12 lg:mb-16">
          <div className="relative">
            ...
            <div className="rounded-tl-[50px] rounded-br-[50px] px-8 lg:px-12 py-5 lg:py-6" style={{ backgroundColor: '#FFDE00', boxShadow: '0px 4px 4px rgba(0,0,0,0.25)' }}>
              <h2 className="text-2xl sm:text-3xl lg:text-4xl text-black text-center capitalize whitespace-nowrap" style={{ fontFamily: 'Outfit, sans-serif' }}>
                Departments hiring at <span className="font-medium">iSprout</span>
              </h2>
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
          {jobs.map((job, index) => (
            ...
            >
              <div>
                <h3 className="font-semibold text-black text-base lg:text-lg mb-2 capitalize min-h-[3rem]" style={{ fontFamily: 'Poppins, sans-serif' }}>
                  {job.title}
                </h3>
                <p className="text-black capitalize mb-6" style={{ fontFamily: 'Poppins, sans-serif' }}>
              ...
              <button 
                ...
                onMouseLeave={(e) => {
                  e.currentTarget.style.backgroundColor = 'rgba(32,71,88,0.79)';
                }}
              >
                Apply Here
              </button>
