...
const Centre = () => {
	...
	const centreMetaData: { [key: string]: { title: string; description: string; keywords: string } } = {
		"orbit": {
			...
			keywords: "Orbit office space, Knowledge City workspace, Hyderabad managed office, iSprout Orbit"
		},
		"one-golden-mile": {
			...
			keywords: "One Golden Mile office, Kokapet workspace, Hyderabad office space, iSprout Kokapet"
		},
		"my-home-twitza": {
			...
			keywords: "My Home Twitza office, Raidurg workspace, Hyderabad managed office, iSprout Twitza"
		},
		"jayabheri-trendset-connect": {
			...
			keywords: "Jayabheri Trendset office, Kondapur workspace, Hyderabad office space, iSprout Jayabheri"
		},
		"sohini-tech-park": {
			...
			keywords: "Sohini Tech Park office, Nanakramguda workspace, Hyderabad IT hub, iSprout Sohini"
		},
		"divyasree-trinity": {
			...
			keywords: "Divyasree Trinity office, Madhapur workspace, Hyderabad office space, iSprout Madhapur"
		},
		"modern-profound": {
			...
			keywords: "Modern Profound office, Kondapur workspace, Hyderabad tech park, iSprout Kondapur"
		},
		"pranava-one": {
			...
			keywords: "Pranava One office, Somajiguda workspace, Hyderabad office space, iSprout Pranava"
		},
		"purva-summit": {
			...
			keywords: "Purva Summit office, Whitefield Bangalore, Bengaluru workspace, iSprout Whitefield"
		},
		"sreshta-marvel": {
			...
			keywords: "Sreshta Marvel office, Gachibowli workspace, Hyderabad office space, iSprout Gachibowli"
		},
		"n-r-enclave": {
			...
			keywords: "NR Enclave office, Whitefield Bangalore, Bengaluru workspace, iSprout Whitefield"
		},
		"prestige-saleh-ahmed": {
			...
			keywords: "Prestige Saleh Ahmed office, Infantry Road Bangalore, Bengaluru workspace, iSprout Infantry Road"
		},
		"shilpitha-tech-park": {
			...
			keywords: "Shilpitha Tech Park office, Bellandur workspace, Bangalore office space, iSprout Bellandur"
		},
		jade: {
			...
			keywords: "Jade office Guindy, Chennai workspace, Kochar Jade, iSprout Guindy"
		},
		"sigapi-achi-building": {
			...
			keywords: "Sigapi Achi Building office, Egmore workspace, Chennai office space, iSprout Egmore"
		},
		"s-m-tower": {
			...
			keywords: "SM Tower office, OMR Chennai, Saravana Matrix, iSprout OMR"
		},
		"managed-office-space-gurugram": {
			...
			keywords: "HQ27 office Gurugram, Gurgaon workspace, Delhi NCR office space, iSprout Gurugram"
		},
		"grey-stone": {
			...
			keywords: "Greystone Baner office, Pune workspace, Baner IT zone, iSprout Pune"
		},
		"pune-hinjewadi": {
			...
			keywords: "Hinjewadi office Pune, Panchshil Tech Park, Pune workspace, iSprout Hinjewadi"
		},
		"pune-yerwada": {
			...
			keywords: "Yerwada office Pune, Panchshil workspace, Pune office space, iSprout Yerwada"
		},
		vijayawada: {
			...
			keywords: "Benz Circle office Vijayawada, VJA workspace, Vijayawada office space, iSprout Vijayawada"
		},
		"medha-towers-vijayawada": {
			...
			keywords: "Medha Towers office, Gannavaram workspace, Vijayawada office space, iSprout Medha Towers"
		},
		"managed-office-space-in-kolkata": {
			...
			keywords: "Godrej Waterside Kolkata, Bidhannagar office, Salt Lake workspace, iSprout Kolkata"
		},
		"managed-office-space-ahmedabad": {
			...
			keywords: "Aurelien office Ahmedabad, Makarba workspace, Ahmedabad office space, iSprout Ahmedabad"
		},
		"managed-office-space-in-visakhapatnam": {
			...
			keywords: "Lansum Square Visakhapatnam, Maddilapalem office, Vizag workspace, iSprout Visakhapatnam"
		}
	};
	...
	const findCenterFromOurLocations = () => {
	...
	const centerFromOurLocations = findCenterFromOurLocations();
