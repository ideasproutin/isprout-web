  ...
  return (
    <div className="w-full bg-[#f2f3c8] py-16 px-4 relative">
      ...
      <div className="max-w-6xl mx-auto">
        {/* Title */}
        <h2 className="text-4xl font-bold mb-12 text-center" style={{ fontFamily: 'Outfit, sans-serif', color: '#2C3E50' }}>
          Spaces That Inspire: Explore iSprout's Stunning Offices
        </h2>

        {/* Nearby Spaces Label - Left corner above first card */}
        <h3 className="text-2xl font-bold mb-6" style={{ fontFamily: 'Outfit, sans-serif', color: '#2C3E50' }}>
          Nearby Spaces
        </h3>
        ...
        <div className="relative">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {spaces.slice(currentIndex, currentIndex + 3).map((space, index) => (
              <div key={index} className="group">
                ...
                <div className="mt-4">
                  <h3 className="text-xl font-bold mb-2" style={{ fontFamily: 'Outfit, sans-serif', color: '#2C3E50' }}>
                    {space.name}
                  </h3>
                  <div className="flex items-center text-gray-600 text-sm">
                    <span className="mr-2">📍</span>
                    <span style={{ fontFamily: 'Outfit, sans-serif' }}>{space.location}</span>
                  </div>
                </div>
              </div>
            ))}
          ...
          <div className="flex items-center justify-center mt-12 space-x-4">
            ...
            <div className="w-64 h-2 bg-gray-300 rounded-full overflow-hidden">
              <div
                ...
                style={{ width: `${((currentIndex + 1) / (spaces.length - 2)) * 100}%` }}
              ></div>
            </div>
