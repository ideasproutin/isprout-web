...
const ProfileSection: React.FC = () => {
	...
	const [stagedPictureFile, setStagedPictureFile] = useState<File | null>(
		null,
	);
	const [stagedPicturePreview, setStagedPicturePreview] = useState<
		string | null
	>(null);
	...
	const avatarSource =
		isEditing && stagedPicturePreview
			? stagedPicturePreview
				...
				<div className='profile-container'>
					...
					<div className='profile-header'>
						...
						<div className='profile-header-content'>
							...
							<label
								htmlFor={
									isEditing ? "profile-pic-input" : undefined
								}
								onMouseEnter={() =>
									isEditing && setAvatarHovered(true)
								}
								...
								style={{
									...
									border: `2px solid ${isEditing && avatarHovered && !isUploadingPicture ? "rgba(255,255,255,0.9)" : "rgba(255,255,255,0.3)"}`,
									display: "flex",
									alignItems: "center",
							...
							>
								...
								{isEditing &&
									(avatarHovered || isUploadingPicture) && (
										<div
											style={{
												position: "absolute",
												inset: 0,
										...
										style={{
											...
											cursor:
												...
												emailError
													...
													: "pointer",
											background:
												"linear-gradient(135deg, #00275c 0%, #004494 100%)",
											color: "#fff",
											fontFamily: "Outfit, sans-serif",
											transition: "all 0.3s ease",
											opacity:
