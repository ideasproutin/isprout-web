...
import citymapBg from '../../../assets/citymap/citymap_background.png';
import indiaMap from '../../../assets/citymap/india.png';
import yellowCircle from '../../../assets/citymap/citymap_circle1.png';
...
const CityMap: React.FC = () => {
  return (
    <section 
      className="relative w-full min-h-screen py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 lg:px-12 xl:px-16"
      style={{
        backgroundImage: `url(${citymapBg})`,
    ...
    >
      ...
      <img 
        src={yellowCircle} 
        alt="Circle" 
        className="absolute bottom-4 left-4 w-12 h-12 sm:w-16 sm:h-16"
      />
