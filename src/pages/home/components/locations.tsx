...
const Locations: React.FC = () => {
  ...
  const locationsByCity: Record<string, LocationCard[]> = {
    Hyderabad: [
      { image: homePageImages.hydOrbit, name: 'Orbit Knowledge City Hyderabad', title: 'Orbit' },
      { image: homePageImages.hydOgm, name: 'One Golden Mile Kokapet Hyderabad', title: 'One Golden Mile' },
      { image: homePageImages.hydTwitza, name: 'My Home Twiza Hitec City Hyderabad', title: 'My Home Twiza' },
      { image: locationImages.jayabheriLobby, name: 'Jayabheri Trendset Connect, Gachibowli, Hyderabad', title: 'Jayabheri Trendset' },
      { image: locationImages.stpLobby, name: 'Sohini Tech Park, Gachibowli, Hyderabad', title: 'Sohini Tech Park' },
      { image: locationImages.divyasreeLobby, name: 'Divyasree Trinity, Hitec City, Hyderabad', title: 'Divyasree Trinity' },
      { image: locationImages.minaasLobby, name: 'Minaas Center, Hyderabad', title: 'Minaas Center' },
      { image: locationImages.profoundLobby, name: 'Profound Tech Park, Hyderabad', title: 'Profound Tech Park' },
      { image: locationImages.pranavaoneLobby, name: 'Pranava One, Hyderabad', title: 'Pranava One' },
      { image: locationImages.purvaLobby, name: 'Purva Summit, Hyderabad', title: 'Purva summit' },
      { image: locationImages.sasLobby, name: 'SAS Tower, Hyderabad', title: 'SAS Tower' },
      { image: locationImages.shreshtaLobby, name: 'Sreshta Marvel, Hyderabad', title: 'Sreshta Marvel' }
    ],
    Bengaluru: [
      { image: locationImages.nrenclaveLobby, name: 'NR Enclave, Whitefield, Bengaluru', title: 'NR Enclave' },
      { image: locationImages.shilpithaLobby, name: 'Shilpitha Tech Park, Bellandur, Bengaluru', title: 'Shilpitha Tech Park' },
      { image: locationImages.psaLobby, name: 'Prestige Saleh Ahmed, Infantry Road, Bengaluru', title: 'Prestige Saleh Ahmed' }
    ],
    Pune: [
      { image: locationImages.greyLobby, name: 'Grey Stone, Hinjewadi Phase 1, Pune', title: 'Grey Stone' },
      { image: locationImages.panchasilaLobby, name: 'Panchasilal Tech Park, Yerwada, Pune', title: 'Yerwada' },
      { image: locationImages.panchasila1Lobby, name: 'Hinjewadi Tech Park, Pune', title: 'Hinjewadi' }
    ],
    Chennai: [
      { image: locationImages.smtLobby, name: 'SM Towers, Thoraipakkam, Chennai', title: 'SM Tower' },
      { image: locationImages.sigapiachiLobby, name: 'Sigapiachi, Guindy, Chennai', title: 'Sigapiachi' },
      { image: locationImages.jadeLobby, name: 'Kochar Jade, Old Mahabalipuram Road, Chennai', title: 'Jade' }
    ],
    Vijayawada: [
      { image: locationImages.benzLobby, name: 'BenZ Circle, Vijayawada', title: 'Benz Circle' },
      { image: locationImages.medhaLobby, name: 'Medha Towers, Vijayawada', title: 'Medha Towers' }
    ],
    Kolkata: [
      { image: locationImages.godrejLobby, name: 'Godrej Waterside, Kolkata', title: 'Godrej Waterside' }
    ],
    Ahmedabad: [
      { image: locationImages.aurelianLobby, name: 'Aurelian, Ahmedabad', title: 'Aurelian' }
    ],
    Gurugram: [
      { image: locationImages.hq27Lobby, name: 'HQ27, Gurugram', title: 'HQ27' }
    ]
  };
  ...
  const visibleLocations = cityLocations.slice(startIndex, startIndex + cardsPerPage);
  ...
  const handlePrev = () => {
    if (canGoPrev) {
      setCurrentPage(prev => ({ ...prev, [activeCity]: currentCityPage - 1 }));
    }
  };
