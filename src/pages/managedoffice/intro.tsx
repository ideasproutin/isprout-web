        ...
        >
          ...
          >
            ...
            <FeatureCard
              title="Innovation"
              subtitle="stands out"
              style={{ left: "20px", top: "330px", width: "200px", height: "76px", padding: "16px" }}
            />
            <FeatureCard
              title="Flexibility"
              subtitle="& Comfort"
              style={{ left: "240px", top: "390px", width: "200px", height: "76px", padding: "16px" }}
            />
            <FeatureCard
              title="Vibrant"
              subtitle="Community"
              style={{ left: "460px", top: "450px", width: "200px", height: "76px", padding: "16px" }}
            />
          </div>
        </div>
      </div>
