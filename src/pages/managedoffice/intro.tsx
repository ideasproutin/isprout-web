...
import managedOfficeHero from "../../assets/managedofficeintro/managedoffice_herosection.png";
import { COLORS } from "../../helpers/constants/Colors";

const IntroSection: React.FC = () => {
	return (
		<section className='relative w-full min-h-[400px] md:min-h-[480px] lg:min-h-[540px] bg-cover bg-center flex items-end'
			style={{ backgroundImage: `url(${managedOfficeHero})` }}
		>
