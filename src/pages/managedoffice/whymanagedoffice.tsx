import { Settings, Users, TrendingUp, Wifi, DollarSign, MapPin } from 'lucide-react';
...
const WhyManagedOffice = () => {
  ...
  return (
    <section className="w-full py-12 sm:py-16 md:py-20 px-4 sm:px-6 md:px-8 lg:px-16" style={{ backgroundColor: '#f8fafc' }}>
      <div className="max-w-7xl mx-auto">
        {/* Heading */}
        <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-12 sm:mb-16 text-center" style={{ color: COLORS.brandBlueDark, fontFamily: 'Outfit, sans-serif' }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8">
          {benefits.map((benefit, index) => (
            ...
            >
              ...
              <div className="mb-6">
                <div className="w-16 h-16 sm:w-20 sm:h-20 rounded-full flex items-center justify-center" style={{ backgroundColor: '#FFDE00' }}>
                  <div style={{ color: COLORS.brandBlueDark }}>
                    {benefit.icon}
                  </div>
                </div>
              </div>
              ...
              {/* Title */}
              <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4" style={{ color: COLORS.brandBlueDark, fontFamily: 'Outfit, sans-serif' }}>
                {benefit.title}
              </h3>

              {/* Description */}
              <p className="text-base sm:text-lg text-gray-600 leading-relaxed" style={{ fontFamily: 'Outfit, sans-serif' }}>
                {benefit.description}
              </p>
            </div>
          ))}
