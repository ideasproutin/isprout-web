...
const MeetingRoomsIntro = () => {
  ...
  return (
    <div className="overflow-x-hidden" style={{ backgroundColor: COLORS.white }}>
      {/* HERO SECTION (Scaled Canvas) */}
      <section className="w-full overflow-x-hidden" style={{ backgroundColor: COLORS.white }}>
        <div
          ref={wrapRef}
          ...
          <div className="relative w-full" style={{ height: scaledHeight }}>
            ...
            >
              <div className="relative w-full h-full">
                ...
                {/* Feature cards */}
                <FeatureCard title="Productive" subtitle="Focus-Driven" style={{ left: "2%", top: "420px", padding: "12px" }} />
                <FeatureCard
                  title="Professional"
                  subtitle="Client-Ready"
                  style={{ left: "22%", top: "490px", padding: "12px" }}
                />
                <FeatureCard title="Flexible" subtitle="Hourly / Daily" style={{ left: "43%", top: "560px" }} />
              </div>
            </div>
          </div>
        </div>
