...
const teamMembers: TeamMember[] = [
	...
	},
	{
		...
		fullDescription:
			"Manages member experience and service delivery, ensuring quality and consistency across all centres.",
		...
		<div className='w-full bg-white py-12 md:py-16 lg:py-20'>
			...
			<div className='max-w-7xl mx-auto px-6 md:px-12 lg:px-16 mb-16'>
				...
				<div className='space-y-4 text-gray-700 text-base md:text-lg leading-relaxed'>
					<p>
						Meet the masterminds behind the iSprout magic! Our
						fearless leaders are a quirky bunch of workspace
						wizards, each with their own secret sauce for success.
						They're the heart and soul of iSprout, and they're on a
						mission to make your workday awesome, one space at a
						time. With decades of combined experience in real
						estate, design, technology, and business management, our
						leadership team has seen it all and done it all in the
						world of workspaces.
					</p>
					<p>
						They've learned from the best, made mistakes (and boy,
						do they have some funny stories), and emerged with a
						treasure of knowledge that they're eager to put to work
						for you.
					</p>
				</div>
			</div>
