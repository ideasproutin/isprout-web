...
const OurTeamExtras = () => {
  ...
  const lifeImages = [
    lifeImage1, lifeImage2, lifeImage3, lifeImage4,
    lifeImage5, lifeImage6, lifeImage7, lifeImage8
  ];
  const currentLifeImages = lifeImages.slice(lifeImagesPage * 4, (lifeImagesPage + 1) * 4);
  const toggleLifeImagesPage = () => setLifeImagesPage(lifeImagesPage === 0 ? 1 : 0);
