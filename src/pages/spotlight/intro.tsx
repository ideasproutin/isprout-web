...
const SpotlightIntro = () => {
	...
	return (
		<div className='min-h-screen' style={{ backgroundColor: COLORS.white }}>
			<MetaTags
				title='iSprout in the Spotlight | Industry Recognition and Media Coverage'
			...
			<div className='relative w-full pt-20 sm:pt-24 md:pt-28 lg:pt-32 pb-12 lg:pb-20 overflow-hidden -mt-20 sm:-mt-24 md:-mt-28 lg:-mt-32'>
					...
					<div className='relative w-full h-full'>
						<div
							...
							style={{
								...
								boxShadow: "0px 5px 4px 0px rgba(0,0,0,0.25)",
							}}
						></div>
					</div>
				</div>
				...
				<div className='absolute right-6 top-4 w-[360px] h-[360px] lg:right-8 lg:top-4 lg:w-[600px] lg:h-[600px] pointer-events-none z-10'>
					<img
						alt='Leading brand professional'
				...
				<div className='container mx-auto px-4 lg:px-8 relative z-10'>
					<div className='max-w-2xl pt-8 lg:pt-12'>
						...
						>
							...
							<p>
								At iSprout, we&apos;re honored to host industry
								leaders, innovators, and high-growth teams who
								bring energy and excellence to our workspaces.
								Here&apos;s a glimpse of the companies shaping
								remarkable journeys with us.
							</p>
						</div>
					</div>
				</div>
			...
			<div className='relative w-full py-12 lg:py-16 mt-12 lg:mt-20 overflow-hidden'>
				...
				{/* Right side accent */}
				<div
					className='hidden lg:block absolute right-0 top-0 w-[350px] h-[550px]'
					style={{ backgroundColor: "#D2E6F5" }}
				></div>
						...
						<div className='relative w-full lg:w-[500px]'>
							...
							>
								<div
									...
									style={{
										backgroundColor: "rgba(255,222,0,0.27)",
									}}
								></div>
								<div className='relative z-10'>
									...
									>
										&quot;Scaling tech hubs faster with
										iSprout's flexible workspace
										solutions.&quot;
									</p>
									<p
			...
			<div className='relative w-full py-12 lg:py-16 mb-12 lg:mb-20 overflow-hidden'>
				...
				{/* Left side accent */}
				<div
					className='hidden lg:block absolute left-0 top-0 w-[350px] h-[550px]'
					style={{ backgroundColor: "#D2E6F5" }}
				></div>
