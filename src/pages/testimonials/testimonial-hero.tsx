import heroImage from "../../assets/testimonial-page/hero-t.png";
	...
	return (
		<section className='relative w-full h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden'>
			...
			<div className='absolute inset-0'>
				<img
					src={heroImage}
					alt='iSprout Testimonials'
					className='w-full h-full object-cover object-[center_65%]'
				/>
			</div>

			{/* Testimonials Text with Glassy Black Rectangle Background - Full Width at Bottom */}
