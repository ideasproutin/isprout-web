  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="bg-white w-full">
        <div className="w-full flex items-start justify-center pt-10" style={{ backgroundColor: COLORS.white }}>
          {/* wrapper controls available width */}
          <div ref={wrapRef} className="w-full max-w-[1000px] mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 md:gap-12 items-start">
            ...
            <div className="flex flex-col items-start">
              <h2 className="text-2xl sm:text-3xl md:text-4xl mb-4 sm:mb-6" style={{ fontFamily: "Outfit, sans-serif", color: "#00275c" }}>
                <span>Set Up Your </span>
                <span style={{ color: "#FFDE00" }}>Virtual Office</span>
                <span> Today</span>
              </h2>

              <p className="text-base sm:text-lg md:text-xl mb-6 sm:mb-8" style={{ fontFamily: "Outfit, sans-serif" }}>
              ...
              <div className="rounded-xl overflow-hidden w-full max-w-md">
                <img alt="Virtual Office Space" className="w-full h-auto object-cover" src={formImage} />
              </div>
            </div>
            ...
            <div className="bg-white p-5 sm:p-6 md:p-8 rounded-xl w-full">
              <form className="space-y-5 sm:space-y-6">
                  ...
                  <div key={index}>
                    ...
                    <div className="relative">
                      <input
                        ...
                        style={{ border: "2px solid #00275c", fontFamily: "Outfit, sans-serif" }}
                        required
                      />
                      <span className="absolute left-4 top-1/2 -translate-y-1/2">{field.icon}</span>
                    </div>
                  </div>
                ))}

                <div>
                  <label className="block text-base sm:text-lg mb-2" style={{ fontFamily: "Outfit, sans-serif", color: "#00275c" }}>
                    Company Name:
                  </label>
                  <input
                    type="text"
                ...
                <div className="flex items-start gap-3">
                  <input type="checkbox" id="terms" className="mt-1 w-5 h-5" required />
                ...
                <button
                  ...
                  style={{ backgroundColor: "#FFDE00", color: "#00275c", fontFamily: "Outfit, sans-serif" }}
